...
class _ClassScreenState extends State<ClassScreen> {
  ...
  Future getPost() async {
    ...
    QuerySnapshot qn = await firestore.collection('class').orderBy('Day').getDocuments();
                        ...
                        child: ListTile(
                            ...
                            subtitle: Text(
                                snapshot.data[index].data["Day"] +
                                    ' ' +
                                    snapshot.data[index].data["Time1"] +
                                    '-' +
                                    snapshot.data[index].data["Time2"],
  ...
  void deleteData(String index) {
    try {
      databaseReference.collection('class').document(index).delete();
    } catch (e) {
      print(e.toString());
    }
    setState(() {});
